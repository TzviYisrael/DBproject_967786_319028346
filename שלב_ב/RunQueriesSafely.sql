-- ==============================================================================
-- Stage B: Safe runner for IntelliJ/DataGrip
-- Runs all Queries.sql statements inside one transaction and rolls back at the end.
-- Use this file for testing when you do not want INSERT/UPDATE/DELETE changes to stay in the database.
-- ==============================================================================
